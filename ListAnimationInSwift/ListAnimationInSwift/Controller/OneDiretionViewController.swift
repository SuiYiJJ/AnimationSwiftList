//
//  OneDiretionViewController.swift
...
class OneDirectionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        produceButton?.addTarget(self, action: #selector(OneDirectionViewController.loginAction), for: UIControl.Event.touchUpInside )
        ...
        searchButton?.addTarget(self, action: #selector(OneDirectionViewController.searchAction), for: UIControl.Event.touchUpInside)
        ...
        deleteButton?.addTarget(self, action: #selector(OneDirectionViewController.deleteAction), for: UIControl.Event.touchUpInside)
        ...
        insertButton?.addTarget(self, action: #selector(OneDirectionViewController.insertAction), for: UIControl.Event.touchUpInside)
