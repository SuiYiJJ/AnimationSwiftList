//
//  IndirectAddressViewController.swift
...
class IndirectAddressViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        produceButton?.setTitle("生成线性表（间接寻址）", for: UIControl.State.normal)
        produceButton?.addTarget(self, action: #selector(IndirectAddressViewController.produceAction), for: UIControl.Event.touchUpInside )
        ...
        searchButton?.addTarget(self, action: #selector(IndirectAddressViewController.searchAction), for: UIControl.Event.touchUpInside)
        ...
        deleteButton?.addTarget(self, action: #selector(IndirectAddressViewController.deleteAction), for: UIControl.Event.touchUpInside)
        ...
        insertButton?.addTarget(self, action: #selector(IndirectAddressViewController.insertAction), for: UIControl.Event.touchUpInside)
